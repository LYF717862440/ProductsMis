...
//new_page_index:页码，从0开始，
pagination_container：容器对象    return false;}

这样就定制了一个简单的分页控件，如需更多功能，请参照如下属性：

callback：回调函数，就是点击页码除法的js事件，如上面定义的handlePaginationClick函数，
可以通过ajax读取数据，或者控制数据的显隐
